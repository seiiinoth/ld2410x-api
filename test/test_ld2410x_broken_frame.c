...
/* Broken frame test */
void test_ld2410x_broken_frame()
{
  ...
  uint8_t rslt;
  uint8_t inv_rx[]   = {0xFD, 0xFC, 0xFB, 0xFA, 0x04, 0x00, 0x63, 0x01, 0x00, 0x00, 0x02, 0x02, 0x02, 0x01};
  ...
  TEST_ASSERT_EQUAL(LD2410X_E_INVALID_RESPONSE, rslt);
...
int main(void)
{
  ...
  RUN_TEST(test_ld2410x_broken_frame);
